  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.DialogPortal>
        ...
        <Dialog.DialogContent className="fixed inset-0 flex w-full flex-col overflow-hidden rounded-md bg-slate-700 outline-none md:inset-auto md:left-1/2 md:top-1/2 md:h-[60vh] md:max-w-[640px] md:-translate-x-1/2 md:-translate-y-1/2">
